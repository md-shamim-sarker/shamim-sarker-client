...
const UpdateNotesInterview = () => {
    ...
    return (
        <form onSubmit={newNoteHandler} className='w-11/12 mx-auto mb-10'>
            <h3 className='text-3xl font-bold text-center my-10'>Update Interview Questions</h3>
            <div className='flex w-full gap-y-3 flex-col'>
                ...
                <div className='text-lg'>
                    <ReactQuill tabIndex={3} theme="snow" defaultValue={note2.code} onChange={setCode} />
                </div>
                <button type='submit' className='btn btn-primary rounded-none'>Update</button>
            </div>
        </form>
    );
};

export default UpdateNotesInterview;